    ...
    $.ui.position = {
        fit: {
            ...
            top: function(position, data) {
                ...
                position.top =
                    over > 0 ? position.top - over : Math.max(position.top - data.collisionPosition.top, position.top);
            }
        },
                    ...
                    function(i) {
                        ...
                        if (this.instance._intersectsWith(this.instance.containerCache)) {
                            ...
                            if (!this.instance.isOver) {
                                ...
                                this.instance.currentItem = $(self).clone().appendTo(this.instance.element)
        ...
        "iframeFix",
        {
            ...
            stop: function(event, ui) {
                $("div.ui-draggable-iframeFix")
                    .each(function() { this.parentNode.removeChild(this); }); //Remove frame helpers
            }
        });
        ...
        "animate",
        {
            stop: function(event, ui) {
                ...
                var pr = self._proportionallyResizeElements,
                    ista = pr.length && (/textarea/i).test(pr[0].nodeName),
                    soffseth =
                        ista && $.ui.hasScroll(pr[0], "left") /* TODO - jump height */ ? 0 : self.sizeDiff.height,
                    soffsetw = ista ? 0 : self.sizeDiff.width;
        ...
        "containment",
        {
            start: function(event, ui) {
                ...
                // i'm a node, so compute top, left, right, bottom
                    ...
                    self.containerSize =
                        { height: (element.innerHeight() - p[3]), width: (element.innerWidth() - p[1]) };
            ...
            resize: function(event, ui) {
                ...
                if (cp.top < (self._helper ? co.top : 0)) {
                    self.size.height =
                        self.size.height + (self._helper ? (self.position.top - co.top) : self.position.top);
                ...
                var woset = Math.abs((self._helper ? self.offset.left - cop.left : (self.offset.left - cop.left)) +
                        self.sizeDiff.width),
                    hoset = Math.abs((self._helper ? self.offset.top - cop.top : (self.offset.top - co.top)) +
                        self.sizeDiff.height);
        ...
        $.ui.mouse,
        {
            ...
            _intersectsWithPointer: function(item) {
                ...
                var isOverElementHeight =
                    ...
                    isOverElementWidth = $.ui.isOverAxis(this.positionAbs.left + this.offset.click.left,
                        item.left,
                        item.width),
    ...
    $.widget("ui.dialog",
        {
            ...
            open: function() {
                ...
                if (options.modal) {
                    uiDialog.bind("keypress.ui-dialog",
                        function(event) {
                    ...
                    this.handles.each(function(i, j) {
                        ...
                        if (self.options.range === true) {
                            if (self.orientation === "horizontal") {
                                if (i === 0) {
                                    self.range.stop(1, 1)[animate ? "animate" : "css"]({ left: valPercent + "%" },
                                        o.animate);
                                }
                                if (i === 1) {
                                ...
                                if (i === 0) {
                                    self.range.stop(1, 1)[animate ? "animate" : "css"]({ bottom: (valPercent) + "%" },
                                        o.animate);
                                }
                                if (i === 1) {
                                    self.range[animate ? "animate" : "css"](
            ...
            _tabify: function(init) {
                ...
                if (init) {
                    ...
                    if (o.selected >= 0 && this.anchors.length) {
                        self.element.find(self._sanitizeSelector(self.anchors[o.selected].hash))
                ...
                this.anchors.bind(o.event + ".tabs",
                    function() {
                        var el = this,
                            $li = $(el).closest("li"),
...
// Parse strings looking for color tuples [255,255,255]
    function getRGB(color) {
        ...
        if (result = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(color))
            return [
                parseInt(result[1] + result[1], 16), parseInt(result[2] + result[2], 16),
    ...
    $.extend($.effects,
        {
            ...
            createWrapper: function(element) {
                ...
                wrapper =
                    element.parent(); //Hotfix for jQuery 1.4 since some change in wrap() seems to actually loose the reference to the wrapped element
    ...
    $.effects.bounce = function(o) {
        ...
        return this.queue(function() {
            ...
            var distance = o.options.distance ||
                (ref == "top" ? el.outerHeight({ margin: true }) / 3 : el.outerWidth({ margin: true }) / 3);
            ...
            if (mode == "hide") { // Last Bounce
                ...
                animation1[ref] = (motion == "pos" ? "-=" : "+=") + distance;
                animation2[ref] = (motion == "pos" ? "+=" : "-=") + distance;
                el.animate(animation1, speed / 2, o.options.easing).animate(animation2,
                    speed / 2,
                    o.options.easing,
                    function() {
                        $.effects.restore(el, props);
...
(function($, undefined) {
    ...
    $.effects.drop = function(o) {
        ...
        return this.queue(function() {
            ...
            var motion = (direction == "up" || direction == "left") ? "pos" : "neg";
            var distance = o.options.distance ||
                (ref == "top" ? el.outerHeight({ margin: true }) / 2 : el.outerWidth({ margin: true }) / 2);
            if (mode == "show") el.css("opacity", 0).css(ref, motion == "pos" ? -distance : distance); // Shift
...
(function($, undefined) {
    ...
    $.effects.slide = function(o) {
        ...
        return this.queue(function() {
            ...
            var motion = (direction == "up" || direction == "left") ? "pos" : "neg";
            var distance = o.options.distance ||
                (ref == "top" ? el.outerHeight({ margin: true }) : el.outerWidth({ margin: true }));
            if (mode == "show")
