...
Sys.Mvc.FormContext.$12 = function($p0) {
    ...
    $3.push(Function.createDelegate(null,
        function() {
...
Sys.Mvc.RegularExpressionValidator.create = function(rule) {
    ...
    return Function.createDelegate(new Sys.Mvc.RegularExpressionValidator($0),
...
Sys.Mvc.StringLengthValidator.create = function(rule) {
    ...
    return Function.createDelegate(new Sys.Mvc.StringLengthValidator($0, $1),
